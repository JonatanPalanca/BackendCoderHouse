 ...
 *         description: Error interno del servidor.
 */
router.get("/api/products/mockingproducts", async (req, res) => {
  try {
    let products = [];
    for (let i = 0; i < 100; i++) {
 ...
 *               result: "OK"
 */
router.get("/api/products/loggerTest", (req, res) => {
 ...
 *         description: Error interno del servidor.
 */
router.get("/api/products/products", redirectToLogin, async (req, res) => {
  try {
    ...
    const prevLink = queryValue
      ? `/api/products/products?page=${prevPage}&limit=${limit}&queryValue=${queryValue}&query=${query}`
      : `/api/products/products?page=${prevPage}&limit=${limit}`;
    const nextLink = queryValue
      ? `/api/products/products?page=${nextPage}&limit=${limit}&queryValue=${queryValue}&query=${query}`
      : `/api/products/products?page=${nextPage}&limit=${limit}`;
 ...
 *         description: Error interno del servidor.
 */
router.get("/api/products/home", redirectToLogin, async (req, res) => {
  try {
